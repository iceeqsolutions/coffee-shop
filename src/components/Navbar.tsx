...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-neutral-100 h-56 flex fixed top-0 left-0 w-full z-10 shadow-2xl">
        <div className="flex justify-between w-full desktop:relative">
          <img
            className="h-40 m-5"
            src="src/assets/images/BeanyCupLogo.png"
            alt="Webshop logo"
          />
          <div className="flex w-3/4 justify-center bottom-2 desktop:w-full desktop:justify-around desktop:absolute">
            <div className="ml-20 mr-2 linkText flex h-full items-center justify-center gap-20 flex-grow desktop:mx-20 desktop:gap-10 desktop:justify-around">
              <NavLink
                className="pt-1 px-5 pb-2 text-2xl text-yellow-600"
                to="/"
              >
                Home
              </NavLink>
